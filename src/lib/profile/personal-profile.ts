...
export const PERSONAL_APPLICATION_PLANS: ApplicationPlan[] = [
  {
    id: "plan-dev-br",
    title: "Vertente Dev · Full-Stack / Eng. Software (Brasil)",
    weeklyTarget: 8,
    roleFocus: ["Full Stack", "Product Engineer", "Software Engineer", "Estágio Dev"],
    channels: ["Gupy", "LinkedIn", "Greenhouse", "carreiras oficiais"],
    notes: "~50% do volume. Remoto/híbrido SP e São Carlos. Evidências Prism + Maestro.",
    active: true,
  },
  {
    id: "plan-dados-br",
    title: "Vertente Dados · Analista / Analytics · Estatística USP",
    weeklyTarget: 8,
    roleFocus: ["Data Analyst", "Analista de Dados", "Analytics", "Estágio Dados", "BI"],
    channels: ["Gupy", "LinkedIn", "portfólio DataFlow", "carreiras oficiais"],
    notes: "~50% do volume — esforço igual à Dev. Currículo/ênfase dados; USP como sinal de formação.",
    active: true,
  },
  {
    id: "plan-dev-frontend",
    title: "Dev · sub Frontend React/Next (quando sobrar capacidade)",
    weeklyTarget: 2,
    roleFocus: ["Frontend", "Estágio"],
    channels: ["Gupy", "LinkedIn"],
    notes: "Só se o WIP Dev principal estiver sob controle. UI/React Query nos bullets.",
    active: true,
  },
  {
    id: "plan-intl",
    title: "Remoto intl (LatAm / PT) — misto Dev + Dados",
    weeklyTarget: 2,
    roleFocus: ["Full Stack", "Data Analyst", "Product Engineer"],
    channels: ["LinkedIn", "Wellfound", "RemoteOK"],
    notes: "≈10% do volume. Inglês ok; case study EN.",
    active: true,
  },
];
...
export function buildPersonalProfilePayload() {
  const profile: ProfileData & Record<string, unknown> = {
    ...
    headline:
      "Duas vertentes · Dev (Full-Stack) e Dados (Analytics · Estatística USP) | TypeScript, React, Node.js, Python, SQL",
    summary:
      "Estudante de Estatística e Ciência de Dados na USP com duas vertentes claras e esforço equilibrado: (1) Dev — aplicações full-stack, APIs e produtos web com TypeScript, React/Next.js e Node.js; (2) Dados — análise, qualidade de dados e produtos analíticos com Python, SQL, Pandas e estatística aplicada. Projetos e demos públicas em ambas as frentes.",
